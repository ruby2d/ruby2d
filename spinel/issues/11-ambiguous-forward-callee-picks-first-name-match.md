...
Follow-up to [#3783](https://github.com/matz/spinel/issues/3783), whose reproduction passes at `20a06d01`. The same loss of captured locals still happens when more than one method shares the forwarded name.
